...
- The normative P0–P9 workflow, schemas, evidence custody, and handoff gates live under `framework/skills/research/`. JSON/JSONL is canonical; Markdown is derived.
