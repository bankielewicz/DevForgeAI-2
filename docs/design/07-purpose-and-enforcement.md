...
| Question | Decision |
|---|---|
| Is Research exempt from the anatomy? | Yes. It is specified against `capabilities/research/`, keeps its own typed status set, and is not governed by the seven sub-phases. Which rungs apply to it is still open; see the review, section 5. |
