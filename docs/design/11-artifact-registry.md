...
Every anatomy-governed non-Research skill owns its templates under `.devforgeai/skills/<name>/templates/`. Research uses the typed schemas and contracts under `capabilities/research/` instead and owns no template in this registry.
