...
| `impact_analyzer.md` | `impact_analyzer` | none | Read, Grep, Glob, Bash(devforgeai status) | `.claude/agents/amend-impact_analyzer.md`, `.codex/agents/amend-impact_analyzer.toml` |
