//! SHA-256 (FIPS 180-4), dependency-free. Used for record blobs, the release
//! identity file and the repository identity of an attestation.
...
mod tests {
    ...
    fn known_vectors() {
        ...
        assert_eq!(super::hex(&long), "cdc76e5c9914fb9281a1c7e284d73e67f1809a48a497200e046d39ccc7112cd0");
    }
}
